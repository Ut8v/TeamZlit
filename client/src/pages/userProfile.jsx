        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-purple-400 to-blue-500 p-6">
            <motion.div 
                ...
                <div className="mt-6 flex justify-center gap-4">
                    {isEditing ? (
                        <Button className="bg-green-500 hover:bg-green-600" onClick={handleSave}>Save</Button>
                    ) : (
                        <Button className="bg-blue-500 hover:bg-blue-600" onClick={() => setIsEditing(true)}>Edit Profile</Button>
                    )}
                </div>
            </motion.div>
        </div>
